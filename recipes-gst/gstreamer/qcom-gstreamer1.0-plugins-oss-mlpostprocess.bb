...
SUMMARY = "Qualcomm open-source GStreamer Plug-in for ML mlpostprocess"
SECTION = "multimedia"
...
SRC_URI = "${SRCPROJECT};branch=${SRCBRANCH};subpath=gst-plugin-mlpostprocess"
S = "${WORKDIR}/gst-plugin-mlpostprocess"
