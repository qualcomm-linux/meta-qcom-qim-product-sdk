...
SUMMARY = "Qualcomm open-source GStreamer Plug-in for limiting video buffers rate to its fps"
SECTION = "multimedia"
...
SRC_URI = "${SRCPROJECT};branch=${SRCBRANCH};subpath=gst-plugin-sync"
S = "${WORKDIR}/gst-plugin-sync"
