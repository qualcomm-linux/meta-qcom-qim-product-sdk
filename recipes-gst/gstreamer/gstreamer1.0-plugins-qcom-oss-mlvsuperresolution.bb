...
SRC_URI = "git://git.codelinaro.org/clo/le/platform/vendor/qcom-opensource/gst-plugins-qti-oss.git;protocol=https;rev=e56febe4d65fe6f30e894746527029b7194b022e;branch=imsdk.lnx.2.0.0.r1-rel;subpath=gst-plugin-mlvsuperresolution"
