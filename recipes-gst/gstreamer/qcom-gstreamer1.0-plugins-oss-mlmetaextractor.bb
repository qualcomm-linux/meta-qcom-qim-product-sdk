...
SUMMARY = "Qualcomm open-source GStreamer Plug-in for copying mlmeta from video buffer into text buffer."
SECTION = "multimedia"
...
SRC_URI = "${SRCPROJECT};branch=${SRCBRANCH};subpath=gst-plugin-mlmetaextractor"
S = "${WORKDIR}/gst-plugin-mlmetaextractor"
