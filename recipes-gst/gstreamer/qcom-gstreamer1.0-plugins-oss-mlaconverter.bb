...
SUMMARY = "Qualcomm open-source GStreamer Plug-in for Audio Preprocessing for ML"
...
SRC_URI = "${SRCPROJECT};branch=${SRCBRANCH};rev=${SRCREV};subpath=gst-plugin-mlaconverter"
S = "${WORKDIR}/gst-plugin-mlaconverter"
