...
To download the `qcom-6.6.52-QLI.1.3-Ver.1.3` release

```shell
repo init -u https://github.com/qualcomm-linux/qcom-manifest -b qcom-linux-kirkstone -m qcom-6.6.52-QLI.1.3-Ver.1.3.xml
repo sync
```
...
To download the `qcom-6.6.52-QLI.1.3-Ver.1.1_qim-product-sdk-1.1.3` release tag
```shell
git clone https://github.com/qualcomm-linux/meta-qcom-qim-product-sdk -b qcom-6.6.52-QLI.1.3-Ver.1.1_qim-product-sdk-1.1.3 layers/meta-qcom-qim-product-sdk
```
