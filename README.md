...
To download the `qcom-6.6.119-QLI.1.8-Ver.1.0_qim-product-sdk-2.3.0` release tag
```shell
git clone https://github.com/qualcomm-linux/meta-qcom-qim-product-sdk -b qcom-6.6.119-QLI.1.8-Ver.1.0_qim-product-sdk-2.3.0 layers/meta-qcom-qim-product-sdk
```
