...
To download the `qcom-6.6.65-QLI.1.4-Ver.1.1` release
...
To download the `qcom-6.6.65-QLI.1.4-Ver.1.1_qim-product-sdk-1.1.2` release tag
```shell
git clone https://github.com/qualcomm-linux/meta-qcom-qim-product-sdk -b qcom-6.6.65-QLI.1.4-Ver.1.1_qim-product-sdk-1.1.2 layers/meta-qcom-qim-product-sdk
```
