...
To download the `qcom-6.6.119-QLI.1.8-Ver.1.1` release

```shell
repo init -u https://github.com/qualcomm-linux/qcom-manifest -b qcom-linux-scarthgap -m qcom-6.6.119-QLI.1.8-Ver.1.1.xml
repo sync
```
...
To download the `qcom-6.6.119-QLI.1.8-Ver.1.1_qim-product-sdk-2.3.1` release tag
```shell
git clone https://github.com/qualcomm-linux/meta-qcom-qim-product-sdk -b qcom-6.6.119-QLI.1.8-Ver.1.1_qim-product-sdk-2.3.1 layers/meta-qcom-qim-product-sdk
```
