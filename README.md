...
To download the `qcom-6.6.97-QLI.1.6-Ver.1.2.1` release
...
To download the `qcom-6.6.97-QLI.1.6-Ver.1.2.1_qim-product-sdk-2.1.1` release tag
```shell
git clone https://github.com/qualcomm-linux/meta-qcom-qim-product-sdk -b qcom-6.6.97-QLI.1.6-Ver.1.2.1_qim-product-sdk-2.1.1 layers/meta-qcom-qim-product-sdk
```
